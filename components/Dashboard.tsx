    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className={`p-8 rounded-[2rem] flex flex-col md:flex-row justify-between items-center gap-6 border transition-all duration-700 ${
        ...
        <div className="flex items-center gap-6">
          <div className={`w-16 h-16 rounded-full flex items-center justify-center transition-all ${isEmergency ? 'bg-[#E31937] text-white scale-110' : 'bg-[#E31937] text-white shadow-lg'}`}>
            {isEmergency ? (
        ...
        {isEmergency && (
          <div className="bg-white/10 backdrop-blur-md px-8 py-4 rounded-3xl border border-white/20 text-center">
             <p className="text-[10px] uppercase font-black text-white/60 mb-1">Guaranteed Response</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-[#1D1D1D] p-10 rounded-[2.5rem] shadow-2xl text-white flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group">
             ...
             <div className="relative z-10 text-center md:text-left">
                <h3 className="text-3xl font-black mb-2 uppercase leading-none tracking-tighter">Enercare Advantage</h3>
                <p className="text-slate-400 text-sm font-medium">Book your home comfort consultation today and save up to $7,500.</p>
             </div>
             <a 
              href={BOOKING_URL} 
              target="_blank" 
              rel="noreferrer" 
              className="enercare-pill px-10 py-5 font-black hover:scale-105 shadow-2xl relative z-10 whitespace-nowrap text-base"
             >
               BOOK ASSESSMENT
             </a>
          </section>
        ...
        <div className="space-y-6">
          ...
          <section className="bg-slate-100/50 border border-slate-200 p-8 rounded-[2.5rem]">
             <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-6">Internal System Log</h3>
             <div className="space-y-4">
